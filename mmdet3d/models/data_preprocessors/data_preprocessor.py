    ...
    def voxelize(self, points: List[Tensor],
        ...
        if self.voxel_type == 'hard':
            ...
            for i, res in enumerate(points):
                ...
                # print(f'point2voxel_map: {point2voxel_map}')
                # print(f'res.shape: {res.shape}')
                # print(f'point2voxel_map.shape: {point2voxel_map.shape}')
                # print(f'inds: {inds.shape}')
                # c = Counter(point2voxel_map.tolist())
                # print(f'len(counter(point2voxel_map)): {len(c)}')
